...
class TestNewsSelenium(StaticLiveServerTestCase):
    ...
    def setUp(self):
        ...
        # firefox_options.add_argument('--profile-root=/home/giliazova/Desktop/DjangoBasics1/BraniacLMS1/var/tmp')
        # self.selenium = WebDriver(executable_path=settings.SELENIUM_DRIVER_PATH_FF, options=firefox_options)
